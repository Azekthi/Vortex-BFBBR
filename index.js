...
const GAMEID = 'spongebobsquarepantsbattleforbikinibottomrehydrated'; //Nexus Mods ID (the part of the URL before "mods")
const GAME_NAME = 'SpongeBob SquarePants: Battle for Bikini Bottom - Rehydrated';
const GAME_SHORTNAME = 'Battle for Bikini Bottom Rehydrated';
const GAME_ARTWORK = 'gameart.png';
const EXE_PATH = 'SpongeBob_BFBB_R.exe';

// Game store IDs - fill in the ones that apply, leave any others as ''.
const STEAMAPP_ID = '969990';
const GOGAPP_ID = '1545755591';
//const EPICAPP_ID = '';
const GAMESTORES = [STEAMAPP_ID, GOGAPP_ID];
...
*/
const UNREALDATA = {
  modsPath: path.join('Pineapple', 'Content', 'Paks', '~mods'),
  fileExt: '.pak',
  loadOrder: true,
}
